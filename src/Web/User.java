...
public class User {
        ...
        public static void loginToSite() throws IOException {
                try {
                        ...
                        if (site.getDocument().getElementsByClass(
        ...
        public static void printHtml() {
                ...
                int elementsQuantity = site.getDocument().getElementsByClass(
                                "mdc-layout-grid__cell mdc-layout-grid__cell--span-6-tablet mdc-layout-grid__cell--span-8-desktop")
                                .size();
                ...
                for (int i = 1; i < elementsQuantity; i++) {
                        ...
                        System.out.println(site.getDocument().getElementsByClass(
                                        "mdc-layout-grid__cell mdc-layout-grid__cell--span-6-tablet mdc-layout-grid__cell--span-8-desktop")
                                        .get(i).text().substring(elementsStart, elementsStop));
                }
